...
function numbersSqrdImproved(numbers) {
  for (let i = 0; i < 13; i++){
    return numbers[i]^2
  }
}

// Could be improved only if the length of the array iteration is hard-coded to the current length of the array
...
// ANSWER: Space for each function scales with the size of the string
